...
def main():
    ...
    options = ['input_folder=', 'd2v_model_path=', 'n_examples=', 'n_epochs=', 'learning_rate=', 'mini_batch_size=',
               'momentum=', 'lr_decay=', 'help=', 'test_folder=', 'doc_max_size=']
    try:
        opts, args = getopt.getopt(sys.argv[1:], 'i:m:n:e:l:b:w:d:h:t:', options)
